...
\begin{itemize}
  \item \texttt{EMG\_Hand\_Presentation.pptx} --- 8-slide deck sized for a 5-minute slot with 4 presenters. Three things to fill in: team-name placeholders (slide 1), a photo of the wearable + hand (slide 4), and your real confusion-matrix numbers (slide 7). To rebuild after edits: \texttt{node build\_presentation.js}.
